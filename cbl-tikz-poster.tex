...
%\begin{center}
%\includegraphics[height=30cm]{nasa-space-weather}
%\end{center}
\myfig{magnetosphere}{1.0}

%\myfig{nasa-space-weather}{0.7}
...
\begin{tabular}{ |p{5cm}|p{13cm}|p{6cm}|p{6cm}|  }
\hline
...
$C(u,v) = \mathbb{E}[Dst(u) \times Dst(v)] = |u|^{2H} + |v|^{2H} - |u-v|^{2H}$
